...
// Tu código acá:
  const selectorDeId = document.querySelector("#createdBy").innerHTML;
  document.querySelector("#createdBy").innerHTML = "Aplicacion creada por Tomas";
...
function buildToDos(toDos) {
  // Tu código acá:
  var nuevoArr = toDos.map(buildToDo);
  return nuevoArr;
}
